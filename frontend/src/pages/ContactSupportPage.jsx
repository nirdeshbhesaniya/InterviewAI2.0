        ...
        <div className="min-h-screen bg-[rgb(var(--bg-body))]">
            ...
            <div className="bg-[rgb(var(--bg-card))] border-b border-[rgb(var(--border-subtle))]">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        <button
                            onClick={() => navigate(-1)}
                            className="flex items-center gap-2 text-[rgb(var(--text-secondary))] hover:text-[rgb(var(--text-primary))] transition-colors"
                        >
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <motion.div
                    ...
                    className="mt-16 bg-[rgb(var(--bg-card))] rounded-2xl shadow-card border border-[rgb(var(--border-subtle))] p-8"
                >
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {/* Community */}
                        <div className="text-center p-6 bg-[rgb(var(--bg-elevated-alt))] rounded-xl border border-[rgb(var(--border-subtle))]">
                            <div className="w-12 h-12 bg-[rgb(var(--accent))]/20 rounded-full flex items-center justify-center mx-auto mb-4">
                            ...
                            <h4 className="font-semibold text-[rgb(var(--text-primary))] mb-2">Community Forum</h4>
                        ...
                        <div className="text-center p-6 bg-[rgb(var(--bg-elevated-alt))] rounded-xl border border-[rgb(var(--border-subtle))]">
                            ...
                            <h4 className="font-semibold text-[rgb(var(--text-primary))] mb-2">Documentation</h4>
                            <p className="text-[rgb(var(--text-secondary))] text-sm">
                        ...
                        <div className="text-center p-6 bg-[rgb(var(--bg-elevated-alt))] rounded-xl border border-[rgb(var(--border-subtle))]">
                            ...
                            <h4 className="font-semibold text-[rgb(var(--text-primary))] mb-2">Video Tutorials</h4>
                            <p className="text-[rgb(var(--text-secondary))] text-sm">
